...
import static io.github.wadsg.selenium_bdd.steps.Utility.*;
    ...
    */
    ...
    public void i_switch_to_tab_titled(String pageTitle){
        ...
        for(String windowHandle : driver.getWindowHandles()){
            if (driver.switchTo().window(windowHandle).getTitle().equals(pageTitle)) {
    ...
    public void i_enter_the_value_into_the_text_box_below_the_label(String value, String label){
        ...
        if(labelElement != null) {
            try {
                textElement = driver.findElement(withTagName("input").below(labelElement));
                if(textElement.getAttribute("value") != null) {
                    textElement.sendKeys(Keys.CONTROL, "a", Keys.DELETE);
                }
        ...
        if(labelElement != null && textElement == null){
            try {
                textElement = driver.findElement(withTagName("textarea").below(labelElement));
                if(textElement.getAttribute("value") != null) {
                    textElement.sendKeys(Keys.CONTROL, "a", Keys.DELETE);
                }
                textElement.sendKeys(value);
    ...
    public void i_enter_the_value_into_the_text_box_above_the_label(String value, String label){
        ...
        if(labelElement != null) {
            WebElement textElement = driver.findElement(withTagName("input").above(labelElement));
            if(textElement.getAttribute("value") != null) {
                textElement.sendKeys(Keys.CONTROL, "a", Keys.DELETE);
            }
            textElement.sendKeys(value);
    ...
    public void i_enter_the_value_into_the_text_box_nearest_the_label_that_is_below_the_label(
        ...
        try {
            WebElement belowElement = driver.findElement(By.xpath("//label[contains(.,'" + belowLabel + "')]"));

            try {
                WebElement nearestElement =
                        driver.findElement(byXPath("//label[contains(.,'" + nearestLabel + "')]").
                                below(belowElement));

                getInputWebElementNearest(nearestElement, "text").sendKeys(value);
    ...
    public void i_enter_the_value_into_the_text_box_with_label(String value, String label) {
        ...
        if(labelElement != null) {
            try{
                getInputWebElementNearest(labelElement, "text").sendKeys(value);
            }catch (NoSuchElementException noSuchElementException){

            }
            if(inputElement == null){
                try{
                    driver.findElement(withTagName("input").below(labelElement)).sendKeys(value);
                }catch (NoSuchElementException noSuchElementException){
    ...
    public void i_enter_the_value_into_the_password_box_nearest_the_label(String value, String label) {
        getInputWebElementNearest(label, "password").sendKeys(value);
    }
    ...
    public void i_enter_the_value_into_the_password_box_with_label(String value, String label) {
        ...
        if(labelElement != null) {
            try{
                getInputWebElementNearest(labelElement, "password").sendKeys(value);
            }catch (NoSuchElementException noSuchElementException){
    ...
    public void i_enter_the_value_into_the_number_box_nearest_the_label(String value, String label) {
        getInputWebElementNearest(label, "number").sendKeys(value);
    }
    ...
    public void i_enter_the_value_into_the_number_box_with_label(String value, String label) {
        ...
        if(labelElement != null) {
            try{
                getInputWebElementNearest(labelElement, "number").sendKeys(value);
            }catch (NoSuchElementException noSuchElementException){
    ...
    @When("^I enter the value \"(.*)\" into the email box nearest the label \"(.*)\"$")
    public void i_enter_the_value_into_the_email_box_nearest_the_label(String value, String label) {
        getInputWebElementNearest(label, "email").sendKeys(value);
    }

    @When("^I enter the value \"(.*)\" into the email box with the label \"(.*)\"$")
    public void i_enter_the_value_into_the_email_box_with_label(String value, String label) {
        WebElement labelElement = null;
        try {
            labelElement = driver.findElement(By.xpath("//label[contains(.,'" + label + "')]"));
        }catch(NoSuchElementException noSuchElementException){
        ...
        if(labelElement != null) {
            try{
                inputElement = getInputWebElementNearest(labelElement, "email");
    ...
    public void i_enter_the_date_into_the_date_picker_nearest_the_label(String value, String label) {
        getInputWebElementNearest(label, "date").sendKeys(value);
    }
    ...
    public void i_enter_the_date_into_the_date_picker_with_label(String value, String label) {
        ...
        if(labelElement != null) {
            try{
                getInputWebElementNearest(labelElement, "date").sendKeys(value);
            }catch (NoSuchElementException noSuchElementException){
    ...
    public void i_click_the_button_labelled(String label) throws InterruptedException {
        ...
        if (webElement == null){
            try{
                webElement = driver.findElement(By.xpath("//span[contains(.,'" + label + "')]"));
            } catch(NoSuchElementException noSuchElementException){
        ...
        if (webElement == null){
            try{
                webElement = driver.findElement(By.xpath("//button[contains(.,'" + label + "')]"));
            } catch(NoSuchElementException noSuchElementException){
    ...
    public void i_click_the_button(String label) throws InterruptedException {
        ...
        if (webElement == null){
            try{
                webElement = driver.findElement(By.xpath("//button[contains(@class,'" + label + "')]"));
            } catch(NoSuchElementException noSuchElementException){
    ...
    public void i_click_the_button_above_the_label(String label) {
        WebElement labelElement1 = driver.findElement(By.xpath("//button[contains(.,'" + label + "')]"));
        WebElement button = driver.findElement(withTagName("button").above(labelElement1));
    ...
    public void i_click_the_button_below_the_label(String label) {
        WebElement labelElement1 = driver.findElement(By.xpath("//button[contains(.,'" + label + "')]"));
        WebElement button = driver.findElement(withTagName("button").below(labelElement1));
        JavascriptExecutor jse = (JavascriptExecutor) driver;
        jse.executeScript("arguments[0].click()", button);
    }
    ...
    public void i_click_the_check_box_button_nearest_the_label(String label) {
        getInputWebElementNearest(label, "checkbox").click();
    }
    ...
    public void i_click_the_check_box_button_with_label(String label) {
        ...
        if(labelElement != null) {
            try{
                getInputWebElementNearest(labelElement, "checkbox").click();
            }catch (NoSuchElementException noSuchElementException){

            }
            if(inputElement == null){
                try{
                    driver.findElement(withTagName("input").below(labelElement)).click();
                }catch (NoSuchElementException noSuchElementException){
    ...
    public void i_select_the_value_from_the_multiple_select_list_nearest_the_label(String value, String label) {
        getSelectNearest(label).selectByVisibleText(value);
    }
    ...
    public void i_unselect_the_value_from_the_multiple_select_list_nearest_the_label(String value, String label) {
        getSelectNearest(label).deselectByVisibleText(value);
    }
    ...
    public void i_select_the_values_from_the_multiple_select_list_nearest_the_label(String value1, String value2, String label) {
        Select select = getSelectNearest(label);
    ...
    public void i_unselect_the_values_from_the_multiple_select_list_nearest_the_label(String value1, String value2, String label) {
        getSelectNearest(label).deselectAll();
    }
    ...
    public void the_check_box_button_nearest_the_label_is_selected(String label) {
        Assert.assertTrue(getInputWebElementNearest(label, "checkbox").isSelected());
    }
    ...
    public void the_check_box_button_nearest_the_label_is_unselected(String label) {
        Assert.assertFalse(getInputWebElementNearest(label, "checkbox").isSelected());
    }
    ...
    public void I_should_see_the_message(String status) throws InterruptedException {
        ...
        String message = null;
        try {
            message = driver.findElement(By.xpath("//p[contains(.,\"" + status + "\")]")).getText();
        ...
        if (message == null){
            try {
                message = driver.findElement(By.xpath("//*[contains(text(),'" + status + "')]")).getText();
            } catch (org.openqa.selenium.InvalidSelectorException invalidSelectorException){
    ...
    public void content_appears_on_the_page_including_the_word(String word) throws InterruptedException {
        ...
        String message = null;
        try {
            message = driver.findElement(By.xpath("//h6[contains(.,'" + word + "')]")).getText();
        } catch(NoSuchElementException noSuchElementException){
        ...
        if (message == null){
            try{
                message = driver.findElement(By.xpath("//h5[contains(.,'" + word + "')]")).getText();
            } catch(NoSuchElementException noSuchElementException){
        ...
        if (message == null){
            try{
                message = driver.findElement(By.xpath("//h4[contains(.,'" + word + "')]")).getText();
            } catch(NoSuchElementException noSuchElementException){
        ...
        if (message == null){
            try{
                message = driver.findElement(By.xpath("//h3[contains(.,'" + word + "')]")).getText();
            } catch(NoSuchElementException noSuchElementException){
        ...
        if (message == null){
            try{
                message = driver.findElement(By.xpath("//span[contains(.,'" + word + "')]")).getText();
            } catch(NoSuchElementException noSuchElementException){
        ...
        if (message == null){
            try{
                message = driver.findElement(By.xpath("//th[contains(.,'" + word + "')]")).getText();
            } catch(NoSuchElementException noSuchElementException){
